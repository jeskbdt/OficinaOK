// PERSONALIZE: oficinas e preços por participante (uma vaga por inscrição).
const CONFIG = {
  optionField: 'workshop', detailField: 'session', maxQuantity: 1, success: 'Inscrição simulada',
  options: {
    coados: { label: 'O universo dos coados', price: 95 },
    latte: { label: 'Primeiros passos no latte art', price: 140 },
    sensorial: { label: 'Sabores & aromas', price: 110 }
  }
};
