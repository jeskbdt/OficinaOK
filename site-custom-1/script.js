// PERSONALIZE: livros e preços (mantenha as chaves iguais aos values do HTML).
const CONFIG = {
  optionField: 'book', maxQuantity: 4, success: 'Reserva de leitura simulada',
  options: {
    jardim: { label: 'O jardim das pequenas coisas', price: 48 },
    atlas: { label: 'Atlas dos dias', price: 56 },
    reparar: { label: 'A arte de reparar', price: 42 }
  }
};
