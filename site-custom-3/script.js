// PERSONALIZE: categorias e valores do festival fictício.
const CONFIG = {
  optionField: 'ticket', maxQuantity: 4, success: 'Ingresso reservado na simulação',
  options: {
    pista: { label: 'Pista', price: 120 },
    meia: { label: 'Pista / meia-entrada', price: 60 },
    lounge: { label: 'Lounge', price: 220 }
  }
};
